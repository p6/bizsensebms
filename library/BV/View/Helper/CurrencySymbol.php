 ...
 * @version    $Id:$
 */
class BV_View_Helper_CurrencySymbol extends Zend_View_Helper_Abstract
{
    ...
    public function currencySymbol()
    {
       ...
       $variableModel->setVariable('finance_currency_symbol');
       $currencySymbol = $variableModel->getValue();
