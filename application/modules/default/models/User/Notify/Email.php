...
class Core_Model_User_Notify_Email
{
    public $db;

    public function __construct()
    {
        $this->db = $this->db = Zend_Registry::get('db');

    }

    /*
     * The observable calls this method
     * And passes the user object
     * Call the appropriate method based on the status of the observable
     */
    ...
    /*
     * send emails when a user is created
     */
    public function notifyCreated()
    {
        ...
        /*
         * Notify boss, branch manager and other subscribers
         */
    }
