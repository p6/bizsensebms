...
class Core_Model_Finance_Payslip extends Core_Model_Abstract
{
     ...
     * @param payslipId
     */
     public function __construct($payslipId = null)
     {
        if (is_numeric($payslipId)) {  
            $this->_payslipId = $payslipId;
        }
        parent::__construct();
        $this->_payslipFieldModel = new Core_Model_Finance_PayslipField;
        $this->_payslipItemModel = new Core_Model_Finance_Payslip_Item;
     }

	/**
     * @see Core_Model_Abstract::_dbTableClass
     */
    protected $_dbTableClass = 'Core_Model_DbTable_Finance_Payslip';
