...
class Core_Model_Invoice_ServicePdf extends fpdf
{
    ...
    function Header()
    {
        ...
        $this->Cell(30,7,'SERVICE INVOICE',0);
    ...
    public function writeBillingAddress()
    {
        ...
        $this->cell(55, 5,'Service Invoice To', 1, 1, 'C',1);
        ...
        $this->SetTextColor(255,255,255);
        $this->SetXY(10,95);
        $this->cell(100,5,'Service Invoice Summary',1,1,'C',1);
        $this->SetTextColor(0,0,0);
        $date = "Date";
        ...
        $this->cell(50,5,'Service Invoice ID',1,0);
        ...
        $this->cell(50,5,$invoiceIdToPrint,1,1);
    ...
    {
        $serviceNameHelper = new BV_View_Helper_ServiceItemName();

        $serviceName = $serviceNameHelper->serviceItemName(
                $row['service_item_id']
            );
    ...
    {           
        ...
        $amount = $row['amount'];
        $this->MultiCell(25, $diff, number_format($amount,2,'.',','), 1, 'R', $this->_fill);
        ...
        $this->MultiCell(25, $diff, $taxName, 1, 'C', $this->_fill);
        ...
        $this->SetXY($this->_xBeforeItemPrint+130, $this->_yBeforeItemPrint);
