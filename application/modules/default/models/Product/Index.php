 ...
 * @version    $Id:$
 */
class Core_Model_Product_Index extends Core_Model_Index_Abstract
{
    ...
    public function getPaginator()
    {
         ...
         */
        switch ($sort) {
            case "service_nameAsc" :
                $select->order('name');
            break;
            case "service_nameDes" :
                $select->order('name DESC');
            break;
            
            case "subscribableAsc" :
                $select->order('subscribable');
            break;
            case "subscribableDes" :
                $select->order('subscribable DESC');
            break;
