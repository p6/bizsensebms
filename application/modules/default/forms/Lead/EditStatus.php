...
class Core_Form_Lead_EditStatus extends Core_Form_Lead_AddStatus
{
    ...
    /*
     * @return Zend_Form
     * Web form to edit lead status
     */
    public function getForm()
    {
        $form = parent::getForm();

        $form->setAction('/lead/editstatus/lead_status_id/' . $this->_leadStatusId);

        $leadStatus = new Core_Model_Lead_Status($this->_leadStatusId);
        $leadStatusData = $leadStatus->fetchAsArray();
        $form->populate($leadStatusData);
        return $form;
    }
