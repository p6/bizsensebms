 ...
 * @version    $Id:$
 */
class Core_Form_Activity_Task_Search extends Zend_Form
{
    public function init() 
    {
        ...
        $statusForm = new Core_Form_Activity_Task_Element_TaskSearchStatus;
        ...
        $this->addElements(
                array($title, $startDateFrom, $startDateTo, 
                    $endDateFrom, $endDateTo, $taskStatus, 
                    $assignedTo ,$submit));
        ...
        $ownerGroup = $this->addDisplayGroup(array('name', 'assigned_to', 'task_status_id'), 'assignedGroup');
