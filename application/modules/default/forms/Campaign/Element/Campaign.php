 ...
 * @version    $Id:$
 */
class Core_Form_Campaign_Element_Campaign
{
    protected $_label = 'Campaign';
    protected $_name = 'campaign_id';
    ...
    public function getElement()
    {
        ...
        $element->setLabel($this->_label)
                ...
                ->setStoreId('campaignStore')
                ->setStoreType('dojo.data.ItemFileReadStore')
                ->setStoreParams(array('url'=>'/campaign/jsonstore'))
