...
class Core_Form_SalesReturn_Create extends Zend_Form
{
    public function init()
    {
       $invoiceDate = new Zend_Dojo_Form_Element_DateTextBox('date');
       $invoiceDate->setRequired(true)
                    ->setLabel('Sales Return Date');
       $this->addElement($invoiceDate);
        
       $this->addElement('text', 'customer_sales_return_reference', array(
                'label' => 'Customer\'s sale return reference',
                'validators' => 
                     array(
