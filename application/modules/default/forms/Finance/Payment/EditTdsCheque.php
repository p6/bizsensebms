 ...
 * @version    $Id:$
 */
class Core_Form_Finance_Payment_EditTdsCheque extends Core_Form_Finance_Payment_TdsCheque
{
    ...
    public function init()
    {
        ...
        $defaultValues['bank_account_id'] = $defaultValues['mode_id'];
        $defaultValues['ledger_id'] = $defaultValues['indirect_expense_ledger_id'];
        $defaultValues['tds_ledger_id'] = $defaultValues['type_id'];
        $tdsModel = new Core_Model_Finance_Payment_Tds;
        $tdsRecord = $tdsModel->fetchbyPaymentId($defaultValues['payment_id']);
        $defaultValues['tax_amount'] = $tdsRecord['tds_amount'];
