...
class Core_Form_Finance_Ledger_Element_Ledgers
{
    protected $_name = 'ledger_id';
    
    protected $_label = 'Ledger';
    ...
    public function getElement()
    {
        ...
        $element->setLabel($this->_label)
                ...
                ->setStoreId('ledgerStore')
                ->setStoreType('dojo.data.ItemFileReadStore')
                ->setStoreParams(array('url'=>'/finance/ledger/ledgerstore'))
