...
if(!dojo._hasResource["chart.layer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["chart.layer"] = true;
dojo.provide("chart.layer");
