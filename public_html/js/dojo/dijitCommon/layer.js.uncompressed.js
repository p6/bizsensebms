...
if(!dojo._hasResource["diitCommon.layer"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["diitCommon.layer"] = true;
dojo.provide("diitCommon.layer");
...
dojo.i18n._preloadLocalizations("dijitCommon.nls.layer", ["ROOT","ar","ca","cs","da","de","de-de","el","en","en-gb","en-us","es","es-es","fi","fi-fi","fr","fr-fr","he","he-il","hu","it","it-it","ja","ja-jp","ko","ko-kr","nl","nl-nl","no","pl","pt","pt-br","pt-pt","ru","sk","sl","sv","th","tr","xx","zh","zh-cn","zh-tw"]);
