<?php
class Admin_UrlAccessTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAdminModelUrlsAreAccessControlled()
    {
        $defaultModuleControllers =  APPLICATION_PATH . '/modules/admin/controllers';
        ...
        foreach ($iterator as $fileInfo) {
            ...
            if (strpos($fileName, "Controller")) {
                $className = "Admin_" . rtrim($fileName, ".php");
                require_once APPLICATION_PATH . '/modules/admin/controllers/' . $fileName;
                ...
                foreach ($methods as $method) {
                   if (strpos($method, "Action")) {
                        ...
                        $urlFound =  'admin/' . $controllerWithoutSuffix . "/" . $actionWithoutSuffix[0];
